...
module.exports = function(i18n) {
  ...
  return {
    "topics": {
      "access": {
        "name": _("Access"),
        "tagline": _("Everyone is able to participate"),
        "issues": {
          "available": {
            "name": _("Availability"),
            "title": _("Who's online?"),
            "narrative": _("Internet usage is spreading like wildfire, and that’s a good thing. The more people connected to the network, the more powerful that network can be. This process will only accelerate as the price for access gets lower and lower, and as Web-enabled devices proliferate, spawning more affordable options."),
            "mozActionCopy": _("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus maximus imperdiet sem et dapibus. Duis quam ante, vestibulum in lectus."),
            "yourActionCopy": _("Donec quis magna eleifend turpis pharetra pulvinar sit amet ut velit. Mauris velit eros, consectetur id ex sed, malesuada tincidunt."),
            "mozActionLink": [
              {
        ...
        "issues": {
          ...
          "dataTracking": {
            ...
            "yourActionLink": [
              ...
              {
                "copy": "Personal data in the modern age",
          ...
          "userAgreements": {
            ...
            "yourActionLink": [
              ...
              {
                "copy": "\"Terms and Conditions May Apply\"",
    ...
    "modals": {
      ...
      "legend": {
        "title": "Explore the most important issues on the web today and what shape they're in.",
        "copy": [
          [
            {
